document.getElementById('bookingForm').addEventListener('submit', async function(event) {
    ...
    try {
        ...
        const customerResponse = await fetch("https://api.mews-demo.com/api/connector/v1/customers/add", {
            method: "POST",
        ...
        const reservationResponse = await fetch("https://api.mews-demo.com/api/connector/v1/customers/add", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                "ClientToken": "E0D439EE522F44368DC78E1BFB03710C-D24FB11DBE31D4621C4817E028D9E1D",
